...
public interface Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> extends Serializable {
     ...
     * @return a partial application of this function
     */
    default Function7<T2, T3, T4, T5, T6, T7, T8, R> apply1(T1 t1) {
        return (T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8) -> apply(t1, t2, t3, t4, t5, t6, t7, t8);
    }
     ...
     * @return a partial application of this function
     */
    default Function7<T1, T3, T4, T5, T6, T7, T8, R> apply2(T2 t2) {
     ...
     * @return a partial application of this function
     */
    default Function7<T1, T2, T4, T5, T6, T7, T8, R> apply3(T3 t3) {
     ...
     * @return a partial application of this function
     */
    default Function7<T1, T2, T3, T5, T6, T7, T8, R> apply4(T4 t4) {
     ...
     * @return a partial application of this function
     */
    default Function7<T1, T2, T3, T4, T6, T7, T8, R> apply5(T5 t5) {
     ...
     * @return a partial application of this function
     */
    default Function7<T1, T2, T3, T4, T5, T7, T8, R> apply6(T6 t6) {
     ...
     * @return a partial application of this function
     */
    default Function7<T1, T2, T3, T4, T5, T6, T8, R> apply7(T7 t7) {
     ...
     * @return a partial application of this function
     */
    default Function7<T1, T2, T3, T4, T5, T6, T7, R> apply8(T8 t8) {
