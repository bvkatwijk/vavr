...
public interface Function4<T1, T2, T3, T4, R> extends Serializable {
     ...
     * @return a partial application of this function
     */
    default Function3<T2, T3, T4, R> curry1(T1 t1) {
        return (T2 t2, T3 t3, T4 t4) -> apply(t1, t2, t3, t4);
    }
     ...
     * @return a partial application of this function
     */
    default Function3<T1, T3, T4, R> curry2(T2 t2) {
     ...
     * @return a partial application of this function
     */
    default Function3<T1, T2, T4, R> curry3(T3 t3) {
     ...
     * @return a partial application of this function
     */
    default Function3<T1, T2, T3, R> curry4(T4 t4) {
