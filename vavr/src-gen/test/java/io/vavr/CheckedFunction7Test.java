...
public class CheckedFunction7Test {
    ...
    class ApplyTests {
      ...
      public void shouldApply1()  throws Throwable {
          final CheckedFunction7<String, String, String, String, String, String, String, String> concat = (String s1, String s2, String s3, String s4, String s5, String s6, String s7) -> s1 + s2 + s3 + s4 + s5 + s6 + s7;
          assertThat(concat.apply1("s1").apply("s2", "s3", "s4", "s5", "s6", "s7")).isEqualTo("s1s2s3s4s5s6s7");
      }

      @Test
      public void shouldApply2()  throws Throwable {
          final CheckedFunction7<String, String, String, String, String, String, String, String> concat = (String s1, String s2, String s3, String s4, String s5, String s6, String s7) -> s1 + s2 + s3 + s4 + s5 + s6 + s7;
          assertThat(concat.apply2("s2").apply("s1", "s3", "s4", "s5", "s6", "s7")).isEqualTo("s1s2s3s4s5s6s7");
      }

      @Test
      public void shouldApply3()  throws Throwable {
          final CheckedFunction7<String, String, String, String, String, String, String, String> concat = (String s1, String s2, String s3, String s4, String s5, String s6, String s7) -> s1 + s2 + s3 + s4 + s5 + s6 + s7;
          assertThat(concat.apply3("s3").apply("s1", "s2", "s4", "s5", "s6", "s7")).isEqualTo("s1s2s3s4s5s6s7");
      }

      @Test
      public void shouldApply4()  throws Throwable {
          final CheckedFunction7<String, String, String, String, String, String, String, String> concat = (String s1, String s2, String s3, String s4, String s5, String s6, String s7) -> s1 + s2 + s3 + s4 + s5 + s6 + s7;
          assertThat(concat.apply4("s4").apply("s1", "s2", "s3", "s5", "s6", "s7")).isEqualTo("s1s2s3s4s5s6s7");
      }

      @Test
      public void shouldApply5()  throws Throwable {
          final CheckedFunction7<String, String, String, String, String, String, String, String> concat = (String s1, String s2, String s3, String s4, String s5, String s6, String s7) -> s1 + s2 + s3 + s4 + s5 + s6 + s7;
          assertThat(concat.apply5("s5").apply("s1", "s2", "s3", "s4", "s6", "s7")).isEqualTo("s1s2s3s4s5s6s7");
      }

      @Test
      public void shouldApply6()  throws Throwable {
          final CheckedFunction7<String, String, String, String, String, String, String, String> concat = (String s1, String s2, String s3, String s4, String s5, String s6, String s7) -> s1 + s2 + s3 + s4 + s5 + s6 + s7;
          assertThat(concat.apply6("s6").apply("s1", "s2", "s3", "s4", "s5", "s7")).isEqualTo("s1s2s3s4s5s6s7");
      }

      @Test
      public void shouldApply7()  throws Throwable {
          final CheckedFunction7<String, String, String, String, String, String, String, String> concat = (String s1, String s2, String s3, String s4, String s5, String s6, String s7) -> s1 + s2 + s3 + s4 + s5 + s6 + s7;
          assertThat(concat.apply7("s7").apply("s1", "s2", "s3", "s4", "s5", "s6")).isEqualTo("s1s2s3s4s5s6s7");
      }
