...
public class Function4Test {
    ...
    class ApplyTests {
      ...
      public void shouldApply1() {
          final Function4<String, String, String, String, String> concat = (String s1, String s2, String s3, String s4) -> s1 + s2 + s3 + s4;
          assertThat(concat.apply1("s1").apply("s2", "s3", "s4")).isEqualTo("s1s2s3s4");
      }

      @Test
      public void shouldApply2() {
          final Function4<String, String, String, String, String> concat = (String s1, String s2, String s3, String s4) -> s1 + s2 + s3 + s4;
          assertThat(concat.apply2("s2").apply("s1", "s3", "s4")).isEqualTo("s1s2s3s4");
      }

      @Test
      public void shouldApply3() {
          final Function4<String, String, String, String, String> concat = (String s1, String s2, String s3, String s4) -> s1 + s2 + s3 + s4;
          assertThat(concat.apply3("s3").apply("s1", "s2", "s4")).isEqualTo("s1s2s3s4");
      }

      @Test
      public void shouldApply4() {
          final Function4<String, String, String, String, String> concat = (String s1, String s2, String s3, String s4) -> s1 + s2 + s3 + s4;
          assertThat(concat.apply4("s4").apply("s1", "s2", "s3")).isEqualTo("s1s2s3s4");
      }
